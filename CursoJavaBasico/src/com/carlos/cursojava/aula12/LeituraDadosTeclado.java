package com.carlos.cursojava.aula12;
...
public class LeituraDadosTeclado {
	...
	public static void main(String[] args) {
		...
		String primeiroNome = scan.next();
		int idade = scan.nextInt();
		byte qdefilhos = scan.nextByte();
		float altura = scan.nextFloat();
		boolean temBichinho = scan.nextBoolean();
		System.out.println("Voce digitou os seguintes dados: ");
		System.out.println("Primeiro nome : " + primeiroNome );
		System.out.println("Idade: " + idade);
		System.out.println("Quantidade de filhos: " + qdefilhos);
		System.out.println("Altura: " + altura);
		System.out.println("Tem pet: " + temBichinho);
